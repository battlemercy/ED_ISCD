    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                {
                    if (numberstolba1 == numberstolba2 && (numberstroki1 + 1 == numberstroki2 || numberstroki1 - 1 == numberstroki2))
                    {
                            Console.WriteLine("Король может туда сходить. YES.");
                    }
                    else if (numberstroki1 == numberstroki2 && (numberstolba1 + 1 == numberstolba2 || numberstolba1 - 1 == numberstolba2))
                    {
                            Console.WriteLine("Король может туда сходить. YES.");
                    }
                    ...
                    else if (a == b && (numberstroki2 != numberstroki1) && (numberstolba1 != numberstolba2))
                    {
                        Console.WriteLine("Король может туда сходить. YES.");
                    }
                    else
                    {
                        Console.WriteLine("Король не может туда сходить. NO.");
                    }
                }
                else
                {
