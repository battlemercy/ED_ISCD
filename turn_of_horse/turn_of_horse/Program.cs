    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                {
                    if ((numberstolba1 + 1 == numberstolba2 && numberstroki1 + 2 == numberstroki2) || (numberstolba1 + 1 == numberstolba2 && numberstroki1 - 2 == numberstroki2) || (numberstolba1 - 1 == numberstolba2 && numberstroki1 + 2 == numberstroki2) || (numberstolba1 - 1 == numberstolba2 && numberstroki1 - 2 == numberstroki2) || (numberstolba1 + 2 == numberstolba2 && numberstroki1 + 1 == numberstroki2) || (numberstolba1 + 2 == numberstolba2 && numberstroki1 - 1 == numberstroki2) || (numberstolba1 - 2 == numberstolba2 && numberstroki1 + 1 == numberstroki2) || (numberstolba1 - 2 == numberstolba2 && numberstroki1 - 1 == numberstroki2))
                    {
                ...
                {
                    Console.WriteLine("Конь не может туда сходить. NO.");
                }
            }
            catch
            {
